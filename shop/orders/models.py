...
class Order(CommonAbstractModel):
    ...
    author = models.ForeignKey(User, verbose_name="Автор", related_name="order", on_delete=models.DO_NOTHING)
    status = models.CharField(choices=Status.choices, verbose_name="Статус", max_length=20)
    total_sum = models.FloatField(verbose_name="Общая сумма", editable=False, default=0)
